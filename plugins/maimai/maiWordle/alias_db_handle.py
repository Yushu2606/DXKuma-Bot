...
class Alias(object):
    ...
    def addalias(self,user_id:str,group_id: str,music_id: str,alias: str,songTitle: str):
        if music_id in self.findSong(alias):
            return "该别名已经存在", 0
            ...
            if update_result.modified_count == 1:
                ...
                if len(examine_data['agreeList']) >= 3:
                    ...
                    if not existing_document:
                        self.alias_collection.insert_one({"music_id": examine_data["music_id"], "alias": [examine_data["alias"]]})
    ...
    def adminAddAlias(self,user_id:str,group_id: str,music_id: str,alias: str,songTitle: str):
        ...
        if not existing_document:
            self.alias_collection.insert_one({"music_id": music_id, "alias": [alias]})
